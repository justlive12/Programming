...
struct Student
{
        ...
        std::ostream& operator << (std::ostream& out, const Student& student)
    {
        ...
        std::string name_delim; for (int i = 0; i < name_len; ++i) name_delim += "─";
        out << "┌─" << name_delim << "─┬───────┬──────┬──────┬──────┬──────┐\n"
...
int main()
{
    ...
    std::vector<Student> students = {
        Student("Oren",        4, 3, 5, 5, 5),
        Student("Luca",    4, 3, 3, 3, 5),
        Student("Emanuel",      4, 3, 5, 2, 5),
        Student("Kendrick",   4, 3, 3, 4, 5),
        Student("Uri",     4, 3, 2, 3, 5),
        Student("Tyrone",     2, 4, 3, 4, 5),
        Student("Ursel",         3, 4, 5, 3, 5),
        Student("William",       2, 2, 5, 3, 5),
        Student("Fidel",     2, 3, 3, 4, 5),
        Student("Bronson",        2, 3, 3, 4, 5),
    };
